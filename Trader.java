...
public class Trader implements Comparable<Trader> {
	...
	/*
	 * Indicates whether some other trader is "equal to" this one, based on comparing their screen names case blind. This method will throw a 
	...
	/*
	 * Creates a new TraderWindow for this trader and saves a reference to it in myWindow. Removes and displays all the messages, if any, from this trader's 
	...
	/*
	 * Adds msg to this trader's mailbox and displays all messages. If this trader is logged in (myWindow is not null) removes and shows all the messages in 
	 * the mailbox by calling myWindow.showMessage(msg) for each msg in the mailbox.
	 */
	...
	/*
	 * Logs out this trader. Calls brokerage's logout for this trader. Sets myWindow to null (this method is called from a TraderWindow's window listener when 
